// script.js
        ...
        function showNotification(message, type) {
            ...
            notification.style.cssText = `
                ...
                top: 100px;
                right: 30px;
                background: ${type === 'success' ? 'linear-gradient(135deg, var(--accent-color), var(--accent-blue))' : 'linear-gradient(135deg, #ff4757, #ff6b35)'};
                color: white;
                padding: 20px 30px;
                border-radius: 15px;
        ...
        window.addEventListener('scroll', () => {
            ...
            const parallaxElements = document.querySelectorAll('.hero::before, .about::before, .services::before, .contact::before');
